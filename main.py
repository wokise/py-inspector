...
def banner():
    ...
    print("  \\  \\/ \\ `--`        |_| |_||_|", end='')
    print('___/', end='')
    print(' |_|_||_/__/ .__/\\___\\__|\\__\\___/_| ', end='')
    print('V 1.9')
    print('   \\  \\  \\                         \033[0;31m[\033[0;33m127.0.0.1\033[0;31m] \033[0;37m|_|\033[0;31m [\033[1;34m192.168.1.1\033[0;31m] \033[0;37m')
    print('    / /| |                          \033[0;31m[\033[0;37mPorted TO Python FROM Ruby\033[0;31m]\033[0;37m')
    print('   /_/ |_|      ')
    print('  ( _\\ ( _\\    #:##       #:##')
    print('                     #:## \n')
